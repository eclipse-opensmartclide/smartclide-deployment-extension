...
const Monitoring = (props) => {
    ...
    const [containersData, setContainersData] = (0, react_1.useState)();
    const [priceData, setPriceData] = (0, react_1.useState)();
    (0, react_1.useEffect)(() => {
        setLoadingChart(false);
        containers &&
            (containers === null || containers === void 0 ? void 0 : containers.map((container) => {
                        ...
                        if (containerNames.indexOf(container === null || container === void 0 ? void 0 : container.name) === -1) {
                            ...
                            return prev === null || prev === void 0 ? void 0 : prev.map((item) => {
                                ...
                                if ((item === null || item === void 0 ? void 0 : item.name) === (container === null || container === void 0 ? void 0 : container.name)) {
                                    ...
                                    ((_e = (_d = item === null || item === void 0 ? void 0 : item.series) === null || _d === void 0 ? void 0 : _d.memory) === null || _e === void 0 ? void 0 : _e.length) >= 6 &&
                                        ((_f = item === null || item === void 0 ? void 0 : item.series) === null || _f === void 0 ? void 0 : _f.memory.shift());
    ...
    return !loadingChart && !loadingPrice ? (react_1.default.createElement("div", { id: "SmartCLIDE-Widget-Monitorig", className: "text-center" },
        ...
        !loadingPrice ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement("div", { id: "WrapperPrice", className: "d-flex mt-1" },
                ...
                priceData &&
                    (priceData === null || priceData === void 0 ? void 0 : priceData.competitor_provider) &&
                    ((_d = priceData === null || priceData === void 0 ? void 0 : priceData.competitor_provider) === null || _d === void 0 ? void 0 : _d.map((data, index) => {
